...
graph_target_points:
  ...
  - type: label
    ...
    content: ['Jährliches Ziel insgesamt: 10 Millionen']
    font: {
      size: 14
      }
  ...
  - type: label
    ...
    yValue: 6.0
    backgroundColor: transparent
    content: ['Jährliches Ziel a) Trinkwasserversorgung: 6 Millionen']
    font: {
      size: 14
      }
    borderColor: transparent
  - type: label
    ...
    yValue: 4.0
    backgroundColor: transparent
    content: ['Jährliches Ziel b) Sanitärversorgung: 4 Millionen']
    font: {
      size: 14
      }
    borderColor: transparent    
...
footer_fields:
  - series: number of people gaining first-time or upgraded access to drinking water or sanitation owing to german support
    label: Anmerkungen
    value: <br>• Die Daten basieren auf einer Sonderauswertung und sind nicht öffentlich zugänglich.<br>• Ab 2019&nbsp;wird die Zeitreihe für die Bereiche Trinkwasserversorgung und Sanitärversorgung getrennt ausgewiesen.
