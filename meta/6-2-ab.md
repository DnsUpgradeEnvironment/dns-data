...
data_start_values: 
  - field: time series
    value: people gaining first-time or upgraded access to drinking water
  - field: time series
    value: xxxnumber of people gaining first-time or improved access to sanitation
  - field: time series
    value: people gaining first-time or upgraded access to drinking water or sanitation        
...
weather_description: Die Anzahl von Personen, die durch deutsche Förderung eine neue oder verbesserte Trinkwasserversorgung erhalten, soll pro Jahr sechs Millionen betragen. Dieses Ziel ist in 2023&nbsp;erfüllt worden. Da sich die Anzahl zwischen 2019&nbsp;und 2023&nbsp;allerdings im durchschnitt verringert hat, wird der Indikator nur als „Leicht bewölkt“ bewertet.<br>Die Anzahl von Personen, die durch deutsche Förderung eine neue oder verbesserte Basissanitärversorgung oder Abwasserbehandlung erhalten, soll pro Jahr vier Millionen betragen. Dieses Ziel ist in 2023&nbsp;verfehlt worden und auch die durchschnittliche Anzahl hat sich zwischen 2019&nbsp;und 2023&nbsp;verringert, sodass der Indikator mit einem „Gewitter“ bewertet wird.<br>Die Aussagekraft der Bewertung der Indikatoren 6.2.a und b ist insofern eingeschränkt, als dass für die durchschnittliche Entwicklung der Indikatoren eigentlich sechs Datenpunkte herangezogen werden. Durch den Zeitreihenbruch in 2019&nbsp;stehen hier allerdings nur fünf Datenpunkte zur Verfügung.        
---
