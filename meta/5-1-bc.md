...
footer_fileds:
  - label: Anmerkung
    value: 'Dabei bedeutet gleichberechtigte Teilhabe, dass eine annähernde numerische Gleichheit angestrebt wird.<br><br>Frauen in Aufsichtsräten: 2015 bis 2021 (Stand: Januar des jeweiligen Jahres).<br><br>Frauen im öffentlichen Dienst des Bundes (Stand: 30.06. des jeweiligen Jahres).<br><br>2021 vorläufige Daten.'    
...
graph_annotations:
  - value: 30.0
    label:
      content: indicator.target_annotation_5_1_b_2030
      position: left
    preset: target_line
  - value: 45.0
    label:
      content: indicator.target_annotation_5_1_c_2025
      position: left
    preset: target_line    
...
data_start_values: 
  - field: time series
    value: women in management positions in business
  - field: time series
    value: women in management positions in the federal civil service    
