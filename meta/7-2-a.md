...
footer_fileds:
  - label: Anmerkung
    value: 2021 teilweise vorläufige Daten.    
...
graph_annotations:
  ...
  - value: 45.0
    label:
      content: indicator.target_annotation_2040
      position: left
    preset: target_line
  - value: 60.0
    label:
...
data_start_values: 
   - field: timeseries
     value: generation of renewable energies as a share of gross final energy consumption    
