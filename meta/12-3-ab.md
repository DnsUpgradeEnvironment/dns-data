...
target_name: Vorbildwirkung der öffentlichen Hand für nachhaltige öffentliche Beschaffung verwirklichen    
target_id: '12.3.1'    
...
- field: display
  value: b) target (min)
- field: title
  value: recycled paper bearing the blue angel label as a proportion of the total paper consumption of the federal administration
- field: title
  value: co2 emissions per mileage of motor vehicles of the public sector
