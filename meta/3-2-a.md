...
footer_fileds:
    label: Anmerkung
    value: Schwefeldioxid (SO2), Stickstoffoxide (NOx ), Ammoniak (NH3), flüchtige organische Verbindungen (NMVOC) und Feinstaub (PM2,5), gemittelter Index der Messzahlen.    

graph_titles: 
  - title: Emissionen von Luftschadstoffen
        

graph_annotations:  - value: 55.0
    label:
