...
weather_indicator_1_target_2: Erhöhung auf 83&nbsp;% bis 2030
...
weather_indicator_1_target_2_item_b_title: Bei Fortsetzung der Entwicklung von 2022 wäre das Ziel um mindestens 5&nbsp;%, aber maximal um 20&nbsp;% der Differenz zwischen Zielwert und dem Wert aus 2022 verfehlt worden.
...
weather_indicator_2: 8.5.b Erwerbstätigenquote (55- bis 64-Jährige)
...
weather_indicator_2_target_1_item_h_title: Bei Fortsetzung der Entwicklung aus 2016 wäre der Zielwert erreicht oder um weniger als 5&nbsp;% der Differenz zwischen Zielwert und dem Wert aus 2016 verfehlt worden.
weather_indicator_2_target_1_item_h_valid: false
weather_indicator_2_target_1_item_i: Sonne
weather_indicator_2_target_1_item_i_title: Bei Fortsetzung der Entwicklung aus 2015 wäre der Zielwert erreicht oder um weniger als 5&nbsp;% der Differenz zwischen Zielwert und dem Wert aus 2015 verfehlt worden.
weather_indicator_2_target_1_item_i_valid: false

weather_indicator_2_target_2: Erhöhung auf 77&nbsp;% bis 2030
...
weather_indicator_2_target_2_item_a_title: Bei Fortsetzung der Entwicklung aus 2023 wäre der Zielwert erreicht oder um weniger als 5&nbsp;% der Differenz zwischen Zielwert und dem Wert aus 2023 verfehlt worden.
weather_indicator_2_target_2_item_a_valid: true
weather_indicator_2_target_2_item_b: Sonne
weather_indicator_2_target_2_item_b_title: Bei Fortsetzung der Entwicklung aus 2022 wäre der Zielwert erreicht oder um weniger als 5&nbsp;% der Differenz zwischen Zielwert und dem Wert aus 2022 verfehlt worden.
...
footer_fields:
  - series: employment rate, older people (55 to 64-year-olds)
    label: Anmerkungen
    value: <br>• Aufgrund einer umfassenden Neugestaltung des Mikrozensus ist ein Vergleich der Daten des Erhebungsjahres 2020&nbsp;mit den Vorjahren nur eingeschränkt möglich (Zeitreihenbruch).<br>• Die Ergebnisse ab 2011, 2012&nbsp;und 2020, 2021&nbsp;sind jeweils nur eingeschränkt mit den Vorjahren vergleichbar.
  - series: employment rate, total (20 to 64-year-olds)
    label: Anmerkungen
    value: <br>• Aufgrund einer umfassenden Neugestaltung des Mikrozensus ist ein Vergleich der Daten des Erhebungsjahres 2020&nbsp;mit den Vorjahren nur eingeschränkt möglich (Zeitreihenbruch).<br>• Die Ergebnisse ab 2011, 2012&nbsp;und 2020, 2021&nbsp;sind jeweils nur eingeschränkt mit den Vorjahren vergleichbar.        
...
weather_description: Die Erwerbstätigenquote unter der 20- bis 64-jährigen Bevölkerung soll bis zum Jahr 2030&nbsp;auf mindestens 83% steigen. Wird die durchschnittliche Steigerung der Berichtsjahre 2018&nbsp;bis 2023&nbsp;beibehalten, wird der Zielwert in 2030&nbsp;knapp verfehlt. Der Indikator 8.5.a wird daher als „Leicht bewölkt“ bewertet.<br>Unter den 55- bis 64-Jährigen soll die Erwerbstätigenquote bis 2030&nbsp;auf mindestens 77% gesteigert werden. Die durchschnittliche Entwicklung der letzten sechs Berichtsjahre lässt vermuten, dass dieser Wert schon früher erreicht wird, sodass der Indikator 8.s.b mit einer „Sonne“ bewertet wird.        
---
