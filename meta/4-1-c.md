...
source_organisation_logo_1: <a href="X" target="_blank" onclick="return confirm_alert('x', 'De')"><img src="https://dnsTestEnvironment.github.io/site/public/OrgImgDe/X.png" alt="Kultusministerien der Länder in Zusammenarbeit mit dem Hessischen Statistischen Landesamt" title=" Klicken Sie hier um zur Homepage der Organisation Kultusministerien der Länder in Zusammenarbeit mit dem Hessischen Statistischen Landesamt zu gelangen." style="height:60px; width:148px; border:transparent"/></a>
