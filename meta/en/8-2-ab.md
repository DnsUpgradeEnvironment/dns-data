...
graph_subtitle: 'Financial balance and structural financial balance: Share of <abbr title="Gross domestic product">GDP</abbr> (current prices); gross domestic product (price-adjusted): Year-on-year change'    
