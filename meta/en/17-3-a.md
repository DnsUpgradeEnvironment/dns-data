...
footer_fileds:
  - label: Notevalue: '2020 provisional data. LDCs: least developed countries. Data based on a special evaluation.'    

graph_titles: 
  - title: Imports from least developed countries (LDCs)
