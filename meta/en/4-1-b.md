...
data_footnotes: Due to comprehensive redesign of the microcensus it is not possible to compare the data of the survey year 2020&nbsp;with previous years (break in time series).<br>• Data is based on a special evaluation and is not publicly available.    
...
weather_indicator_1_target_1_note: "New target as part of the further development of targets of the German Sustainability Strategy (previously: 42% by 2020)."
