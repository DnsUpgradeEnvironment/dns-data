...
footer_fileds:
  - label: Notevalue: The sub-indicator for the Alps is currently left out of the whole data set. The historical values for 1970 and 1975 are reconstructed. Data based on a special evaluation.    
