...
source_organisation_logo_5: <a href="X" target="_blank" onclick="return confirm_alert('X', 'En')"><img src="https://dnsTestEnvironment.github.io/site/public/OrgImgEn/breg.png" alt="X" title=" Click here to visit the homepage of the organizationX" style="height:60px; width:148px; border:transparent"/></a>
...
weather_indicator_3_target_1_item_a_title: No assessment possible.
