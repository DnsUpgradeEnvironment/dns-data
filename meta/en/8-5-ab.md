...
footer_fields:
  - series: employment rate, older people (60 to 64-year-olds)
    label: Notes
    value: "<br>• Due to methodological changes, the results from 2020&nbsp;are only comparable with previous years to a limited extent.<br>• 2021&nbsp;provisional data.<br>• Bremen: Men 2010, women 2010&nbsp;to 2012&nbsp;and 2015&nbsp;limited significance.<br>• Saarland: Women 2010&nbsp;limited significance.<br>• Länder: The data is based on a special evaluation and is not publicly available"
