...
<div>
  <div class="my-header">
    <h5>a) Paper bearing the Blue Angel label as a proportion of the total paper consumption of the direct federal administration: 
...
<div>
  <div class="my-header">
    <h5>b) CO₂ emissions of commercially available vehicles in the public sector: 
