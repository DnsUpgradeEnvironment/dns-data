...
dns_indicator_definition: The indicator shows the population trends for 41&nbsp;selected bird species in the form of an index. The indicator summarises the changes in the populations of selected bird species that represent the most important types of land use and landscape in Germany (sub-indicators for farmland, forests, settlements and inland waters).        
...
target_description: 'The population of representative bird species across various main habitat and landscape types should be increased to at least an index value of 100&nbsp;by 2030.<br>• According to the target formulation, indicator 15.1&nbsp;is assessed as <b>thunderstorm</b> for 2019, as the indicator values have, on average over the past six years, not developed in the desired direction.<br>• Data status at assessment: 13/09/2024.<br><br><u>Note:</u> Due to the calculation methodology of the indicator, the target is not treated as an annually to-be-achieved value if it was reached ahead of schedule (as was the case before 2001).<br><br><a href="https://dnsUpgradeEnvironment.github.io/site/en/status"><img src="https://sdg-indikatoren.de/public/Wettersymbole/Blitz.png" title="In 2019&nbsp;the distance to the target was constantly high or had increased. Thus, the indicator did not develop in the desired direction." alt="Weathersymbol: Thuder strom"/></a>'        
---
