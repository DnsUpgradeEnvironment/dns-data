...
data_footnotes: "Sub index for the Alps: Currently left out of the data set.<br>• Sub index for inland waters and for seas: extrapolated data for single years.<br>• As part of a research project the indicator will be revised and the target value adjusted."        
