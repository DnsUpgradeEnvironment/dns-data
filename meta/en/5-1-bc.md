...
data_footnotes: "¹ In this context, equal participation means striving for approximate numerical equality.<br>• Women on supervisory boards: figures as at January each year.<br>• Women in management positions in the federal civil service: figures as at 30&nbsp;June each year.<br>• Data is based on a special evaluation and is not publicly available."    
...
graph_annotations:
  - value: 30
    label:
      content: Target 2030 - b) Supervisory boards
      position: left
...
<div>
  <div class="my-header">
    <label class="default">b) Supervisory boards: 30% women on supervisory boards by 2030
