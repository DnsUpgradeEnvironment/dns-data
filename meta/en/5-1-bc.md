...
footer_fileds:
    label: Note
    value: In this context, equal representation means that approximately numerical equality is targeted. <br><br>Women on supervisory boards 2015 to 2021 (figures as at January each year).<br><br>Women in management positions in the federal civil service (figures as at 30 June each year).<br><br>2021 provisional data.    

graph_titles: 
  - title: Share of women in management positions
