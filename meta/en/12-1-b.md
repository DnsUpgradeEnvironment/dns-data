...
footer_fileds:
  - label: Notevalue: Provisional data for 2016; not directly comparable with previous years due to methodological changes. Data based on a special evaluation.    
