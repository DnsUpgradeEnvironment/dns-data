...
data_footnotes: Due to comprehensive redesign of the microcensus it is not possible to compare the data of the survey year 2020&nbsp;with previous years (break in time series).<br>• The results from 2020&nbsp;onwards are only comparable with previous years to a limited extent.    
...
weather_indicator_1_target_1_note: New target as part of the further development of targets of the German Sustainability Strategy (previously 10% by 2020).
