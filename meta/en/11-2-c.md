...
data_footnotes: The data is based on a special evaluation and is not publicly available.<br>• The next data update (reporting years 2022&nbsp;and 2024) is planned for 2025.        
...
target_description: The average journey time by public transport to the nearest medium-sized or regional centre should be reduced.<br><br><br>No assessment possible. Too few data points.        
---
