...
target_description: The average travel time by public transport to the nearest medium or regional centre should be reduced.<br>• The current trend is moving in the direction of the target. An assessment of indicator 11.2.c is not possible. Too few data points.<br><br>        
---
