...
data_footnotes: '2021 preliminary data.<br>• Data based on a special evaluation. <br>• <br>• The results from 2020 onwards are only comparable with previous years to a limited extent. <br>• <br>• EU: Data estimated.<br>• Data for the EU with the respective member states in the reporting year (until 2019 EU-28 from 2020 EU-27).'    
