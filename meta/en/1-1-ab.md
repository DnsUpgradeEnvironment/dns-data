...
footer_fileds:
  - label: Notevalue: 'Data based on a special evaluation.<br><br>The results from 2020 onwards are only comparable with previous years to a limited extent.<br><br>EU: Data estimated.'    
