...
dns_indicator_definition: The indicator shows the total number of people who have been trained by experts from the Bundeswehr since 2024&nbsp;to strengthen the control of small arms and light weapons and related ammunition (including securing, registering and destroying small arms and light weapons) in particularly affected regions of the world.        
...
target_description: The number of people trained by experts from the German Armed Forces (Bundeswehr) should be increased to a total of 1,000&nbsp;persons between 2024&nbsp;and 2030.<br>• An assessment of indicator 16.2&nbsp;is not possible. Too few data points.<br><br>        
---
