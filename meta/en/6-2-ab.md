...
footer_fields:
  - series: number of people gaining first-time or upgraded access to drinking water or sanitation owing to german support
    label: Notes
    value: <br>• Data is based on a special evaluation and is not publicly available.<br>• Beginning in 2019, the time series for drinking water supply and sanitation will be reported separately.
...
graph_target_points:
  ...
  - type: label
    ...
    yValue: 17.0
    backgroundColor: transparent
    content: ['Annual target total: 10 million']
    font: {
      size: 14
      }
    borderColor: transparent
  - type: label
    ...
    yValue: 6.0
    backgroundColor: transparent
    content: ['Annual target a) Access to drinking water: 6 million']
    font: {
      size: 14
      }
    borderColor: transparent
  - type: label
    ...
    yValue: 4.0
    backgroundColor: transparent
    content: ['Annual target b) Access to sanitation: 4 million']
    font: {
      size: 14
      }
    borderColor: transparent    
