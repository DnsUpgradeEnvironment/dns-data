...
graph_annotations:
  - value: 6.0
    label:
      content: Constant target - a) Access to drinking water
      position: left
    preset: target_line
  - value: 4.0
    label:
      content: Constant target - b) Access to sanitation
      position: left
    preset: target_line    
...
<div>
  <div class="my-header">
    <h5>6 million people per year by 2030
    </h5>
  </div>
  <div class="my-header-note">
  </div>
...
<div>
  <div class="my-header">
    <h5>4 million people per year by 2030
    </h5>
  </div>
  <div class="my-header-note">
  </div>
