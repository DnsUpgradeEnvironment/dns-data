...
source_organisation_logo_1: <a href="https://ag-energiebilanzen.de/en/" target="_blank" onclick="return confirm_alert('the AG Energiebilanzen e.V.', 'En')"><img src="https://dnsUpgradeEnvironment.github.io/dns-indicators/public/OrgImgEn/ageb.png" alt="AG Energiebilanzen e.V." title=" Click here to visit the homepage of the organizationAG Energiebilanzen e.V." style="height:60px; width:148px; border:transparent"/></a>
...
source_organisation_logo_3: <a href="http://www.lak-energiebilanzen.de/" target="_blank" onclick="return confirm_alert('', 'En')"><img src="https://dnsUpgradeEnvironment.github.io/dns-indicators/public/OrgImgEn/lakeb.png" alt="LAK Energiebilanzen" title=" Click here to visit the homepage of the organizationLAK Energiebilanzen" style="height:60px; width:148px; border:transparent"/></a>
...
footer_fields:
  - series: final energy productivity
    label: Notes
    value: "<br>• 2023&nbsp;provisional data.<br>• Länder: <br>&nbsp;&nbsp;- 2022&nbsp;preliminary data for Baden-Württemberg, Berlin and Hessen."
  - series: primary energy consumption
    label: Notes
    value: "<br>• 2023&nbsp;and 2024&nbsp;provisional data.<br>• Länder: <br>&nbsp;&nbsp;- 2022&nbsp;preliminary data for Baden-Württemberg and Hessen."        
...
weather_indicator_2_target_1_item_a_title: Assessment ended.
...
weather_indicator_2_target_2_item_a_title: If the development from 2021 had continued, the target had been missed by at least 5&nbsp;documentat%, but by a maximum of 20&nbsp;% of the difference between the target value and the value at that time.
...
weather_indicator_2_target_2_item_g_title: If the development from 2015 had continued, the target had been missed by at least 5&nbsp;documentat%, but by a maximum of 20&nbsp;% of the difference between the target value and the value at that time.
...
weather_indicator_2_target_3_item_a: 
weather_indicator_2_target_3_item_a_title: No evaluation possible.
weather_indicator_2_target_3_item_a_valid: true
weather_indicator_2_target_3_item_b: 
weather_indicator_2_target_3_item_b_title: No evaluation possible.
weather_indicator_2_target_3_item_b_valid: true
weather_indicator_2_target_3_item_c: 
weather_indicator_2_target_3_item_c_title: No evaluation possible.
weather_indicator_2_target_3_item_c_valid: true
weather_indicator_2_target_3_item_d: 
weather_indicator_2_target_3_item_d_title: No evaluation possible.
weather_indicator_2_target_3_item_d_valid: true
weather_indicator_2_target_3_item_e: 
weather_indicator_2_target_3_item_e_title: No evaluation possible.
weather_indicator_2_target_3_item_e_valid: true
weather_indicator_2_target_3_item_f: 
weather_indicator_2_target_3_item_f_title: No evaluation possible.
weather_indicator_2_target_3_item_f_valid: true
weather_indicator_2_target_3_item_g: 
weather_indicator_2_target_3_item_g_title: No evaluation possible.
...
weather_indicator_2_target_4_item_a_title: If the trend from 2021 had continued, the target value would have been reached or missed by less than 5% of the difference between the target value and the value at that time.
weather_indicator_2_target_4_item_a_valid: false
weather_indicator_2_target_4_item_b: Sonne
weather_indicator_2_target_4_item_b_title: If the trend from 2020 had continued, the target value would have been reached or missed by less than 5% of the difference between the target value and the value at that time.
weather_indicator_2_target_4_item_b_valid: false
weather_indicator_2_target_4_item_c: Wolke
weather_indicator_2_target_4_item_c_title: Although the indicator has in 2019 been moving in the desired direction toward the target, if the trend had to continued, the target would have been missed in the target year by more than 20% of the difference between the target value and the value at that time.
weather_indicator_2_target_4_item_c_valid: false
weather_indicator_2_target_4_item_d: Wolke
weather_indicator_2_target_4_item_d_title: Although the indicator has in 2018 been moving in the desired direction toward the target, if the trend had to continued, the target would have been missed in the target year by more than 20% of the difference between the target value and the value at that time.
weather_indicator_2_target_4_item_d_valid: false
weather_indicator_2_target_4_item_e: Blitz
weather_indicator_2_target_4_item_e_title: In 2017 the distance to the target was constantly high or had increased. Thus, the indicator did not develop in the desired direction.
weather_indicator_2_target_4_item_e_valid: false
weather_indicator_2_target_4_item_f: Wolke
weather_indicator_2_target_4_item_f_title: Although the indicator has in 2016 been moving in the desired direction toward the target, if the trend had to continued, the target would have been missed in the target year by more than 20% of the difference between the target value and the value at that time.
weather_indicator_2_target_4_item_f_valid: false
weather_indicator_2_target_4_item_g: Sonne
weather_indicator_2_target_4_item_g_title: If the trend from 2015 had continued, the target value would have been reached or missed by less than 5% of the difference between the target value and the value at that time.
