...
target_description: The proportion of adults with obesity should fall or remain constant.<br>Based on the target formulation, the politically defined target of indicator 3.1.f was not achieved in the last year 2021, nor on average over the last six years, so the indicator for 2021&nbsp;is rated as "thunderstorm".        
---
