...
data_footnotes: Pensions not included in social benefits.<br>• Data for the <abbr title="European Union">EU</abbr> with the respective member states in the reporting year (until 2019 <abbr title="European Union">EU</abbr>-28 from 2020 <abbr title="European Union">EU</abbr>-27).<br>• Due to methodological changes, the results from 2020 are only comparable with previous years to a limited extent.<br>• 2021 provisional data.    
