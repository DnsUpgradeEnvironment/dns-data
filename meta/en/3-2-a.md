...
footer_fileds:
  - label: Notevalue: Sulphur dioxide (SO2), nitrogen oxides (NOx), non-methane volatile organic compounds (NMVOCs) and particulate matter (PM2.5), average index of measured values.    
