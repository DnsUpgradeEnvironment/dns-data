...
language: en        
national_indicator_available: Broadband expansion - share of households with access to gigabit broadband        
...
political_target: Comprehensive gigabit broadband coverage by 2025        

type_target: Goal with a specific target value        

data_state: 15.01.2025        

indicator_name: Broadband expansion - share of households with access to gigabit broadband        
section: Innovation        
...
source_organisation_logo_1: <a href="https://bmdv.bund.de/EN/Home/home.html" target="_blank" onclick="return confirm_alert('the Federal Ministry for Digital and Transport', 'En')"><img src="https://dnsTestEnvironment.github.io/dns-indicators/public/OrgImgEn/bmv.png" alt="Federal Ministry for Digital and Transport" title=" Click here to visit the homepage of the organizationFederal Ministry for Digital and Transport" style="height:60px; width:148px; border:transparent"/></a>
