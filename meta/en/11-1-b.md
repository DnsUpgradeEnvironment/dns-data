...
data_footnotes: 'Settlement and transport area: Due to methodological changes in the official survey of land (introduction of the official land register information system (<abbr title="Official land register information system" tabindex="0">ALKIS</abbr>) from the 2016&nbsp;reporting year), the results from 2016&nbsp;are only comparable with previous years to a limited extent (break in time series).<br>• The series shows the four-year moving average of rural and non-rural areas weighted by population.<br>• The data is based on a special evaluation and is not publicly available.'        
