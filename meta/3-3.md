...
dns_indicator_definition: Der Indikator umfasst Ausgaben <abbr title='beziehungsweise'>bzw.</abbr> Zusagen Deutschlands für Programme zur globalen Pandemieprävention und -reaktion. Ausgenommen sind hierbei Programme zur Eindämmung der COVID-19-Pandemie. Um die Aussagekraft des Indikators zu verbessern, wird er bis zur nächsten Neuauflage der DNS im Hinblick auf seine Wirkung evaluiert, mit dem Ziel, ihn zu einem Output-Indikator fortzuentwickeln.    
...
graph_title: Ausgaben <abbr title='beziehungsweise'>bzw.</abbr> Zusagen zur globalen Pandemieprävention und -reaktion    
