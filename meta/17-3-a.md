...
footer_fileds:
  - label: Anmerkungvalue: 2020 vorläufige Daten. LDCs = Am wenigsten entwickelte Länder (Least Developed Countries). Die Daten basieren auf einer Sonderauswertung.    

graph_titles: 
  - title: Einfuhren aus am wenigsten entwickelten Ländern (LDCs)
