...
graph_annotations:
  - series: final energy productivity
    value: 239.3763
    label:
      content: indicator.target_annotation_7_1_a_2050
      position: left
    preset: target_line
  - series: primary energy consumption
    value: 80.0
    label:
      content: indicator.target_annotation_7_1_b_2020
      position: left
    preset: target_line
  - series: primary energy consumption
    value: 70.0
    label:
      content: indicator.target_annotation_7_1_b_2030
      position: left
    preset: target_line
  - series: primary energy consumption
    value: 50.0
    label:
      content: indicator.target_annotation_7_1_b_2050
      position: left
    preset: target_line    
