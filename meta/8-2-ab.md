...
target_name: Staatsfinanzen konsolidieren – Generationengerechtigkeit schaffen    
target_id: '8.2.1'    
...
- field: display
  value: b) target (min)
- field: title
  value: funding balance (share of gross domestic product (at current prices) in %)
- field: title
  value: structural funding balance (share of gross domestic product (at current prices) in %)
- field: title
  value: gross domestic produkt (price-adjusted) (year-on-year changes in %)
