...
political_target: "12.3.a: Deutliche Steigerung des Anteils der Vergaben in der öffentlichen Beschaffung, bei denen Nachhaltigkeitskriterien berücksichtigt werden, so dass dies bis 2030&nbsp;im Regelfall erfolgt<br>12.3.b: Signifikante Senkung<br>12.3.c: Steigerung auf 50&nbsp;Prozent bis 2026"        
...
source_organisation_5: <a href="X" target="_blank" onclick="return confirm_alert('der Bundesregierung', 'De')">Bundesregierung (Monitoringbericht Maßnahmeprogramm Nachhaltigkeit)</a>
source_organisation_5_short: <a href="X" target="_blank" onclick="return confirm_alert('der Bundesregierung', 'De')">Bundesregierung (Monitoringbericht Maßnahmeprogramm Nachhaltigkeit)</a>
source_organisation_logo_5: <a href="X" target="_blank" onclick="return confirm_alert('der Bundesregierung', 'De')"><img src="https://dnsTestEnvironment.github.io/site/public/OrgImgDe/X.png" alt="Bundesregierung (Monitoringbericht Maßnahmeprogramm Nachhaltigkeit)" title=" Klicken Sie hier um zur Homepage der Organisation Bundesregierung (Monitoringbericht Maßnahmeprogramm Nachhaltigkeit) zu gelangen." style="height:60px; width:148px; border:transparent"/></a>
...
target_description: '12.3.a: Keine Bewertung möglich. Zu wenig Datenpunkte.<br>12.3.b: Ausgehend von der Zielformulierung entwickelte sich Indikator 12.3.b im letzten Berichtsjahr (2022) in die gewünschte Richtung. Die Entwicklung im Durchschnitt der letzten sechs Berichtsjahre ging jedoch nicht in die gewünschte, sodass der Indikator 12.3.b mit "Wolke" bewertet wird.<br>12.3.c: Keine Bewertung möglich. Zu wenig Datenpunkte.'        
---
