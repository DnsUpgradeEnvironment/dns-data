...
dns_indicator_definition_new: '12.3.a: Der Indikator stellt den finanzvolumenmäßigen Anteil der öffentlichen Aufträge/Konzessionen dar, in deren Vergabeverfahren mindestens ein soziales oder umweltbezogenes <abbr title="beziehungsweise" tabindex="0">bzw.</abbr> innovatives Nachhaltigkeitskriterium einbezogen worden ist, an dem Gesamtvolumen der vergebenen öffentlichen Aufträge/Konzessionen.'        
