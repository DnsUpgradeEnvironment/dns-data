...
target_name: Arten erhalten – Lebensräume schützen    
target_id: '15.1.1'    
...
- field: display
  value: b) target (min)
- field: title
  value: f) index overall
- field: title
  value: a) sub-index forests
- field: title
  value: b) sub-index settlements
- field: title
  value: c) sub-index farmland
- field: title
  value: d) sub-index inland waters
- field: title
  value: e) sub-index coasts/seas
