...
footer_fileds:
  - series: preservation or restoration of forests in developing countries under the redd+ rulebook
    label: Anmerkungen
    value: <br>• Finanzierungsbeiträge vor 2013 sind in Antizipierung des REDD+-Regelwerks erfolgt.Die Daten basieren auf einer Sonderauswertung.<br>• Finanzierungsbeiträge vor 2013 sind in Antizipierung des REDD+-Regelwerks erfolgt.    
...
data_start_values: 
  - field: Series
    value: german gross bilateral development expenditure for the implementation of the un convention to combat desertification
  - field: Series
