...
history_target_1:  Anteil der Personen, die materiell depriviert sind, bis 2030 deutlich unter <abbr title="Europäische Union">EU</abbr>-28-Wert halten
...
data_start_values:     
- field: title
  value: a) materially deprived persons
- field: title
  value: b) severely materially deprived persons
- field: area
  value: eu-28
- field: area
  value: germany
