...
target_name: Korruption bekämpfen    
target_id: '16.3.1'    
...
data_start_values:     
- field: title
  value: rating for germany
- field: title
  value: number of partner countries of german development cooperation whose rating has improved compared with 2012
