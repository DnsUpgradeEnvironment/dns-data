...
data_start_values: 
  - field: time series
    value: nitrogen input in coastal and marine waters – nitrogen input via the inflows into the north sea
  - field: time series
    value: nitrogen input in coastal and marine waters – nitrogen input via the inflows into the baltic sea    
